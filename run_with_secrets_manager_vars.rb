...
secrets_manager.repository = runner_options[:repo]
secrets_manager.environment = runner_options[:environment]
...
if !vars.is_a?(Array) || vars.empty? || vars.all? { |v| v.strip.empty? }
